...
<body>
    ...
    <div class="container">
        <?php
            ...
            echo "<thead class='table-dark'><tr><th scope='col'>Title</th><th scope='col'>Year</th><th scope='col'>Type</th><th scope='col'>Director</th><th scope='col'>Synopsis</th><th scope='col'>CreatedAt</th><th scope='col'>UpdatedAt</th><th scope='col'>DeletedAt</th></tr></thead>";
            echo "<tbody>";
            
            foreach($films as $key => $info){
                echo "<tr>";
